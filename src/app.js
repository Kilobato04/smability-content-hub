   ...
   if (slide.type === 'cover_bold') {
        ...
        bodyContent = `
            <div style="text-align:left; width:100%; height:100%; position:relative; display:flex; flex-direction:column;">
               ...
               <div style="position:absolute; top:${deviceCircleSize * 0.8}px; right:-15px; text-align:right; z-index:13;">
               ...
               <div class="device-circle" style="position:absolute; top:25px; right:0; width:${deviceCircleSize}px; height:${deviceCircleSize}px; background:#222; border:2px solid #39FF14; border-radius:50%; z-index:10; box-shadow: 0 10px 30px rgba(0,0,0,0.4);">
                </div>

                <div style="position:absolute; top:25px; right:0; width:${deviceCircleSize}px; height:${deviceCircleSize}px; z-index:11; display:flex; align-items:center; justify-content:center; pointer-events:none; overflow:visible;">
